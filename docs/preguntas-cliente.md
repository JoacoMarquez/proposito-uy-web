# Preguntas / pedidos al cliente (Pedro)

Lista viva de cosas que dependen del cliente para poder cerrar tickets.
Cada ítem referencia su ticket de Jira (proyecto PROP).

| # | Estado | Ticket | Qué necesito pedirle |
|---|--------|--------|----------------------|
